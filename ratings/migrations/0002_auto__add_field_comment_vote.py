...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ratings_comment', 'vote',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['ratings.Vote']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.vote'
        db.delete_column(u'ratings_comment', 'vote_id')
    ...
    models = {
        ...
        u'ratings.comment': {
            ...
            'vote': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comments'", 'null': 'True', 'to': u"orm['ratings.Vote']"})
        },
        u'ratings.score': {
